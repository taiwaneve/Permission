...
android {
    namespace = "tw.edu.pu.csim.tcyang.permission"
    compileSdk = 36

    defaultConfig {
        applicationId = "tw.edu.pu.csim.tcyang.permission"
        minSdk = 28
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.10.0") //請確認最新版
